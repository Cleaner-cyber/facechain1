...
base_models = [
    ...
    'revision': 'v1.0.0',
    'sub_path': "realistic",
    'style_list': ['丁达尔(ding)', '冬季汉服(Chinese winter hanfu)', '校服风(School uniform)', '婚纱风(Wedding dress)', '拍立得风(Polaroid style)', '仙女风(Fairy style)', '古风(traditional Chinese Style)', '壮族服装风(zhuangzu)', '欧式田野风(european fields)']},
]
